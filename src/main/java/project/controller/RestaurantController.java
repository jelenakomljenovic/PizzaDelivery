...
import project.exception.DishNotExistException;
...
import project.service.RestaurantServiceImpl;
import project.service.SearchEngineServiceImpl;
...
public class RestaurantController {
  ...
  public int addDishToMenu(@RequestBody String jsonDish)
    ...
    Dish newDish = new Dish(dishName, price, imageUrl, description);
  ...
  public int updateRestaurantInformation(@RequestBody String jsonInfo)
    ...
    RestaurantInfo newInfo = new RestaurantInfo(open, name, description, imageUrl);
    // handle search engine
