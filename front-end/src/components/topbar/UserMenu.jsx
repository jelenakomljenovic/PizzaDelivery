  ...
  render() {
    return (
      <Grid container>
        ...
        >
          <MenuItem style={{color : "#000000"}} onClick={this.openPasswordDialog}>Reset Password</MenuItem>
          <MenuItem style={{color : "#000000"}} onClick={this.openPhoneDialog}>Update Contact Information</MenuItem>
          <MenuItem style={{color : "#000000"}} onClick={this.openAddressDialog}>Update Address</MenuItem>
          <MenuItem style={{color : "#000000"}} onClick={this.logout}>Logout</MenuItem>
          <MenuItem style={{color : "#000000"}} onClick={this.openWarnDialog}>Drop My Account</MenuItem>
        </Menu>
